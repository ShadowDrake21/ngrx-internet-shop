...
An advanced **e-commerce web application** built with **Angular**, **NgRX**, **RxJS**, **Firebase**, and integrated with the **Fake Store API** ([https://fakeapi.platzi.com/](https://fakeapi.platzi.com/)) and **Stripe** for payments.  
...
| **API Source** | Fake Store API ([platzi.com](https://fakeapi.platzi.com/)) |
| **Payments** | Stripe ([Stripe Backend Repo](https://github.com/ShadowDrake21/ngrx-internet-shop-stripe-backend)) |
